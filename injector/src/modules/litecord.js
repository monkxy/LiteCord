...
dataPath = path.join(dataPath, "LiteCord") + "/";

let hasCrashed = false;
export default class LiteCord {
    ...
    static setup(browserWindow) {
        ...
        process.env.LITECORD_DATA_PATH = dataPath;
    ...
    static disableMediaKeys() {
        if (!LiteCord.getSetting("general", "mediaKeys")) return;
...
if (LiteCord.getSetting("developer", "reactDevTools")) {
